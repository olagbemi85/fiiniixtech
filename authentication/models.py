...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    LEVEL_THREE = 3
    LEVEL_FOUR = 4
    TYPE_CHOICES = ((LEVEL_ONE, 'L1'),(LEVEL_TWO, 'L2'),(LEVEL_THREE, 'L3'),(LEVEL_FOUR, 'L4'),)
    customer_level_choices = models.PositiveSmallIntegerField(choices=TYPE_CHOICES, blank=True, null=True)
